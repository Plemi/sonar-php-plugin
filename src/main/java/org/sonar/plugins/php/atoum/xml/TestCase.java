...
public final class TestCase {
  ...
  public TestCase(final int assertions, final String className, final String errorMessage, final String file, final int line,
      final String name, final String status, final List<String> error, final List<String> failure, final double time) {
    super();
  ...
  public String getStackTrace() {
    if (error != null && STATUS_ERROR.equals(getStatus())) {
      return error.toString();
    }
    if (failure != null && STATUS_FAILURE.equals(getStatus())) {
