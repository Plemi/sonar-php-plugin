 ...
 * report file.
 */
public class AtoumCoverageDecorator implements Decorator {

  private static final Logger LOG = LoggerFactory.getLogger(AtoumCoverageDecorator.class);

  private AtoumConfiguration configuration;

  public AtoumCoverageDecorator(AtoumConfiguration configuration) {
